...
from models.tree_scanning import Tree_SSM
...
class TTM(nn.Module):
    ...
    def __init__(self, channels=128, depths=[3, 4, 18, 5],
                 mlp_ratio=4., drop_rate=0., drop_path_rate=0.2, drop_path_type='linear'
                 , act_layer='GELU', norm_layer='LN', layer_scale=None, post_norm=False,
                 with_cp=False, cls_scale=1.5, **kwargs):
        super().__init__()
...
#         print(f"shape, after stem{x.shape}")
        ...
        out = [ element.permute(0, 3, 1, 2) for element in out]
